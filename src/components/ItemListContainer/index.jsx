...
const cars = [
    {id: 1, image: "https://www.autoo.com.br/fotos/2018/2/960_720/volkswagen_amarok_2018_1_26022018_8891_960_720.jpg", category: 'camionetas', title: "Volkswagen Amarok V6 Highline 258cv"},
...
export const ItemListContainer = ({texto}) => {
    ...
    useEffect(() => {
        ...
        if (categoriaId){
            getData.then(res => setData(res.filter(car => car.category === categoriaId)));
        } else {
